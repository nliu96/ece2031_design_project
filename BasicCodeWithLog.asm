...
Move:
	...
	ADD	   X		   ; X - Xpos
	CALL   Abs
	STORE  Xneeded	   ; = xneeded
	IN     YPOS
	CALL   MakeNeg
	ADD    Y	       ; Y - Ypos
	CALL   Abs
	STORE  Yneeded     ; = yneeded
	ADD    Xneeded
	ADDI   -20
	JNEG   NextCall
	ADDI   20
...
AdjLeft:
	...
	JUMP   Move			;
MoveNormal:	
	LOAD   FFast		; load desired speed
	OUT	   LVELCMD		; 
	OUT	   RVELCMD		; output same velocity for both wheels
  	JUMP   Move
...
Yneeded:  DW 0
Angle: 	  DW 0
Distx:    DW 0 ; squared xneeded
Disty:    DW 0 ; squared yneeded
Distance: DW 0 ; distance squared
...
ThreeFeet: DW 879
FourFeet: DW 1172
FiveFeet: DW 1465	   ; ghetto fivefeet
SixFeet:  DW 1758
TenFeet:  DW 2930
TwentyFeet: DW 5860
FourtyFeet: DW 11720
